...
//            );
    ...
    // Thêm các thuộc tính month và year cho việc tính toán
    @Transient
    private int month;
    ...
    // Getter và Setter
    public int getMonth() {
        return played_at != null ? played_at.toLocalDate().getMonthValue() : 0;
    }

    public int getYear() {
        return played_at != null ? played_at.toLocalDate().getYear() : 0;
    }
}
